...
function Home() {
  ...
  const [preferences, setPreferences] = reactExports.useState(null);
  ...
  if (loading) return /*#__PURE__*/React.createElement("div", null, "Loading preferences...");
  if (error) return /*#__PURE__*/React.createElement("div", null, "Error: ", error);
  if (!preferences) return /*#__PURE__*/React.createElement("div", null, "No preferences found");
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", null, "User Preferences"), /*#__PURE__*/React.createElement("div", null, "Theme: ", preferences.theme || "Default"), /*#__PURE__*/React.createElement("div", null, "Layout: ", preferences.dashboardLayout || "Standard"), /*#__PURE__*/React.createElement("div", null, "Notifications: ", preferences.notificationsEnabled ? "On" : "Off"));
}
  ...
  requestUpdate(t, s, i) {
    if (void 0 !== t) {
      const e = this.constructor,
        h = this[t];
      if (i ??= e.getPropertyOptions(t), !((i.hasChanged ?? f$2)(h, s) || i.useDefault && i.reflect && h === this._$Ej?.get(t) && !this.hasAttribute(e._$Eu(t, i)))) return;
      this.C(t, s, i);
    }
...
i$2._$litElement$ = true, i$2["finalized"] = true, s.litElementHydrateSupport?.({
  LitElement: i$2
});
